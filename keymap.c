...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    {
    { KC_TRNS,          KC_NO,          KC_PGUP,        KC_END,         KC_RIGHT,       KC_PGDN,        KC_TRNS,        KC_DEL      },
    { KC_TRNS,          KC_NO,          KC_NO,          KC_HOME,        KC_DOWN,        KC_UP,          KC_LEFT,        KC_INS      },
    ...
    { KC_TRNS,          KC_UP,          KC_TRNS,        KC_END,         KC_RIGHT,       KC_TRNS,        KC_DOWN,        KC_CAPSLOCK },
    },
};
